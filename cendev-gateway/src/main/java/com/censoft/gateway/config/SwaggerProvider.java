package com.censoft.gateway.config;
 ...
 * @PackageName com.censoft.gateway.config
 * @Description 
 * @Author daiz
...
public class SwaggerProvider implements SwaggerResourcesProvider
{
    ...
    public List<SwaggerResource> get()
    {
        ...
        gatewayProperties.getRoutes().stream().filter(routeDefinition -> routeDefinition.getId().equals("cendev-system"))
