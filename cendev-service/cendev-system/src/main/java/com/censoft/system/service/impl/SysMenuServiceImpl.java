...
import com.censoft.common.core.domain.Ztree;
import com.censoft.common.redis.annotation.RedisCache;
import com.censoft.common.utils.StringUtils;
import com.censoft.system.domain.SysMenu;
import com.censoft.system.domain.SysRole;
import com.censoft.system.domain.SysUser;
import com.censoft.system.mapper.SysMenuMapper;
import com.censoft.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenusByUser(SysUser user)
    {
        ...
        else
        {
            ...
            //教育处用户 角色Id赋默认值3
            //分中心用户 角色Id赋默认值4
            String userType = ServletUtils.getRequest().getHeader("userType");
            if(userType!=null && userType.equals(OperatorType.EDUCATION.toString())){
                menus = menuMapper.selecctMenusByRoleId(3L);
                return menus;
            }else if(userType!=null && userType.equals(OperatorType.FCENTER.toString())){
                menus = menuMapper.selecctMenusByRoleId(4L);
                return menus;
            }else{
    ...
    public Set<String> selectPermsByUserId(Long userId)
    {
        ...
        if(userId==0L){
            ...
            if(userType!=null && userType.equals(OperatorType.EDUCATION.toString())){
                ...
                roleId = 4L;
            }else if(userType!=null && userType.equals(OperatorType.GRID.toString())) {
                roleId = 5L;
            }
        }

        perms= roleId!=0L ?  menuMapper.selectPermsByRoleId(roleId) :  menuMapper.selectPermsByUserId(userId) ;
