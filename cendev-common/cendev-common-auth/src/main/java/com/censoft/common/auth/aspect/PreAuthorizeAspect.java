package com.censoft.common.auth.aspect;
...
import com.censoft.common.exception.ForbiddenException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(com.censoft.common.auth.annotation.HasPermissions)")
